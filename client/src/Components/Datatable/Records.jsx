...
import ExpandRecords from './ExpandRecords';
...
const ExpandedComponent = ({ data }) => <ExpandRecords data={data} />;
...
class Records extends Component {
    ...
    getData() {
        ...
        const url = `http://${process.env.REACT_APP_BackURL}db/records?limit=${limit}`
        axios.get(url, {
            headers: {
...
export default withParams(Records);